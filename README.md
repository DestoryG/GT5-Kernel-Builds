# 不再维护！
因更新编译代码过于老旧，本仓库不再维护，现基于Numbersf最新脚本重构[新仓库](https://github.com/DestoryG/GT5-Action-Build)！
# GT5-Kernel-Builds
**```Build Realme GT5's SukiSU Ultra Kernel```** 

适用于Realme GT5(RMX3820/RMX3823)的SukiSU Ultra内核，每日凌晨12点，检测到代码更新自动编译发布。

只能给Realme UI 6.0的设备用！在Realme UI 7.0刷就等着砖吧你。

如果你在寻找RealmeUI 7.0的话，那你应该需要去这里：[点我](https://github.com/DestoryG/GT5-Kernel-Builds-RUI7)
